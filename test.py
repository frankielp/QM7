...
for fold in folds:
    ...
    for epoch in range(1,epochs):
        for iteration in range(1,int(len(fold)/batch)):
            ...
            y_pred = F.leaky_relu(D.bmm(A).bmm(D).bmm(hidden_layer_2).bmm(W7))
...
print("done")
print('master_loss_array',master_loss_array)
print('master_iteration_array',master_iteration_array)
a = master_loss_array
